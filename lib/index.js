...
var oauth2 = function(options) {
    ...
    options.checkAuthorizationHeader = options.checkAuthorizationHeader || true;
    if(typeof options.checkAuthorizationHeader !== 'boolean')
      options.checkAuthorizationHeader = false;
